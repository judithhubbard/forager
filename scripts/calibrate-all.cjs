...
const STEPS = [
  ...
  { name: '1e. cleanup-source-zone-hints', script: 'cleanup-source-zone-hints.cjs', optional: true },
  { name: '1f. cleanup-notes',            script: 'cleanup-notes.cjs',             optional: true },
  ...
  // Pawpaw, mulberry, chinkapin, foxgrape, serviceberry, hazelnut all
  // consolidated as data-driven entries in species-complex-unify.cjs.
  { name: '5. species-complex-unify',     script: 'species-complex-unify.cjs',     optional: false },
