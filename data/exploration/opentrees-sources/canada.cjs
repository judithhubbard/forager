module.exports = [
    ...
    {
        id: 'vancouver',
        // Renamed dataset: Vancouver retired the `street-trees` slug
        // and re-published the same data under `public-trees` (now
        // 187k rows including park + boulevard trees). The old URL
        // 404s; this URL is current as of the deep-crawl pass (#57).
        download:
            'https://opendata.vancouver.ca/explore/dataset/public-trees/download/?format=geojson&lang=en',
        info:
