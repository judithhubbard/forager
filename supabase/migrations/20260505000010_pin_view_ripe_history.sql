-- Extend v_pin_effective with two booleans for the Show filter:
--   has_ripe_observation_this_year — any 'ripe' observation in the
--     region's current calendar year
--   has_ripe_observation_ever — any 'ripe' observation at all
-- Both honor the region timezone for "this year".
