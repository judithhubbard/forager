-- Add best_harvest_quality to v_pin_effective: the max non-null,
-- non-zero quality_rating among ripe observations on the pin.
-- Drives the new "Best harvest ≥ N★" map filters.
