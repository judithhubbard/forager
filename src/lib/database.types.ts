  ...
  public: {
    Tables: {
      ...
      hazards: {
        ...
        Relationships: [
          {
            foreignKeyName: "hazards_pin_id_fkey"
            columns: ["pin_id"]
            isOneToOne: false
            referencedRelation: "pins"
            referencedColumns: ["id"]
      ...
      import_sources: {
        ...
        Relationships: [
          {
            foreignKeyName: "import_sources_region_id_fkey"
            columns: ["region_id"]
            isOneToOne: false
            referencedRelation: "regions"
            referencedColumns: ["id"]
      ...
      invitations: {
        ...
        Relationships: [
          {
            foreignKeyName: "invitations_region_id_fkey"
            columns: ["region_id"]
            isOneToOne: false
            referencedRelation: "regions"
            referencedColumns: ["id"]
      ...
      region_seasonal_shifts: {
        ...
        Relationships: [
          {
            foreignKeyName: "region_seasonal_shifts_region_id_fkey"
            columns: ["region_id"]
            isOneToOne: false
            referencedRelation: "regions"
            referencedColumns: ["id"]
      ...
      species_fruiting_windows: {
        ...
        Relationships: [
          {
            foreignKeyName: "species_fruiting_windows_region_id_fkey"
            columns: ["region_id"]
            isOneToOne: false
            referencedRelation: "regions"
            referencedColumns: ["id"]
      ...
      user_fruiting_window_overrides: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_fruiting_window_overrides_region_id_fkey"
            columns: ["region_id"]
            isOneToOne: false
            referencedRelation: "regions"
            referencedColumns: ["id"]
      ...
      user_species_preferences: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_species_preferences_species_id_fkey"
            columns: ["species_id"]
            isOneToOne: false
            referencedRelation: "species"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      today_doy_in_region: { Args: { rid: string }; Returns: number }
